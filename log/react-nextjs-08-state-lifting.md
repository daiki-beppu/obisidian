...
`_app.js` で共通化して `props` でこページに渡すことでページ間の共通化が可能
...
export default function App({ Component, pageProps }) {
  ...
  return (
    <>
      ...
      >
        {/*
        ここで 子ページに渡す スプレッド構文を使用することで
        count={count} というように一つずつ記述しなくて良くなる
        */}
...
個人的には ドット記法で記述する方法が好き
理由はひと目で親から渡ってきたものだというのがわかるから
ただ、冗長な記述にはなる
