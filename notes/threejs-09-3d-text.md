...
[[threejs-05-geometries]] で学んだジオメトリの応用として、3Dテキストの作成方法を学びます。これまで学んだ [[threejs-08-materials]] のマテリアルと組み合わせることで、立体的な文字を表現できます。
...
3Dテキストの作成ができたら、[[threejs-10-lights]] でライティングを追加することで、より立体感のある表現が可能になります。
