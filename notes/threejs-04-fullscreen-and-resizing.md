...
[[threejs-03-camera]] で学んだカメラ制御に加えて、ブラウザのサイズ変更に対応したり、フルスクリーン機能を実装することで、ユーザー体験が向上します。
...
フルスクリーンとリサイズの対応ができたら、[[threejs-05-geometries]] でさまざまなジオメトリの種類や作成方法を学ぶことで、より複雑な形状を表現できるようになります。
