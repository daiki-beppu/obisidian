...
[[threejs-05-geometries]] で作成したジオメトリの表面に画像を適用することで、よりリアルな質感を表現できます。このテクスチャは [[threejs-08-materials]] でマテリアルと組み合わせて使用します。
...
テクスチャの基礎を理解したら、[[threejs-08-materials]] でさまざまなマテリアルの種類とテクスチャの組み合わせ方を学ぶことで、より高度な表現が可能になります。
